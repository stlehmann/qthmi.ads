...
The documentation for the ADS API is available on
`infosys.beckhoff.de <http://infosys.beckhoff.de/index.php?content=../content/1031/TcAdsDll2/HTML/TcAdsDll_Api_Overview.htm&id=>`_.
